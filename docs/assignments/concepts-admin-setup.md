...
`CLAUDE.md` is a project configuration file that gives [Claude Code](https://code.claude.com/docs/en/overview) context about your project. This connects Assignment 2a and 2b — you'll write one for your EDA project.
