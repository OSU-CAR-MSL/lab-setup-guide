...
| Problem | Fix |
|---------|-----|
| `ssh: connect to host pitzer.osc.edu port 22: Connection refused` | Check if you're on campus or VPN. OSC requires either campus network or VPN for SSH access |
